...
function PrivacyPage() {
  return (
    <MarketingPage
      ...
      lede="Last updated 30 August 2026. This policy is for the Free PDF Safe website and any store listing that opens this same app."
    >
      ...
      <h2>Accounts</h2>
      <p>
        You do not need an account to convert, sign, or scan. Sign-in exists only for the Owner’s Desk, which controls
      ...
      <h2>Analytics</h2>
      <p>
        The public site uses Plausible Analytics, a cookie-free counter of page views. It does not identify you and it
        does not see files you convert, sign, or scan. Those stay on this device.
      </p>
      <h2>What we store</h2>
      <ul>
        <li>On your device: pages you are working on, until you clear them or your browser data.</li>
        <li>
          On our servers: owner-desk settings (ads on/off, AdSense IDs, tagline, notice) and the owner account if one
          exists.
        </li>
